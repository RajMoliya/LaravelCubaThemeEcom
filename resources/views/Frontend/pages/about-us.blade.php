...
@section('content')
    ...
    <div class="row mb-3 mt-3">
        ...
        <div class="col-6" style="padding: 30px">
            ...
            <div class="underline" style="width:50%;margin-left: auto;
            margin-right: auto;"></div>
            <div class=" w-100"></div>At [Company Name], our mission is to revolutionize the way people interact
            with technology. We
    ...
    <div class="row mb-3 mt-3">
        ...
        <div class="col-6" style="padding: 30px">
            ...
            <div class="underline" style="width:20%;margin-left: auto;
            margin-right: auto;"></div>
            <div></div>At [Company Name], our mission is to revolutionize the way people interact
            with technology. We
            believe in harnessing the power of innovation to create products and solutions that simplify complexities and
            enhance everyday experiences. Our team is driven by a passion for pushing boundaries and exploring new
            possibilities in the ever-evolving landscape of technology.
    ...
    <div class="row mb-3 mt-3">
        <div class="col-6" style="padding: 30px">
            ...
            <div class="underline" style="width:60%;margin-left: auto;
            margin-right: auto;"></div>
            <div></div>At [Company Name], our mission is to revolutionize the way people interact
            with technology. We
            believe in harnessing the power of innovation to create products and solutions that simplify complexities and
